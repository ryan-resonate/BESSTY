  ...
  return (
    <div className="map-wrap">
      ...
      <div className="map-status">
        <div className="pill"><span className="dot"></span><b>Mt Brown WF</b><span className="muted">demo</span></div>
        <div className="pill"><span className={'dot'+(ran?'':' warn')}></span><b>{ran?'Calculated':'Not calculated'}</b></div>
        <div className="pill" style={{cursor:'default'}}>
          <b>{wtgs.length}</b>&nbsp;WTGs · <b>{bess.length}</b>&nbsp;BESS · <b>{receivers.length}</b>&nbsp;recv
        </div>
      </div>
      ...
      <div className="map-controls">
        ...
        <div className="compass" title="Bearing">
      ...
      <div className="bottom-tools">
        <div className="grp">
          <button title="Pan"><span className="icon">✥</span> Pan</button>
          ...
          <button title="Draw calc area"><span className="icon">▭</span> Calc area</button>
          <button title="Measure"><span className="icon">📏</span> Measure</button>
        </div>
      </div>

      <div className="legend">
        <div className="ttl"><span>Noise contours</span><span className="unit">L<sub>Aeq</sub> dB</span></div>
        <div className="scale">
        ...
        <hr style={{border:'none',borderTop:'1px solid #ECECEC',margin:'8px 0'}}/>
        <div className="recv-row">
          <span style={{display:'inline-block',width:11,height:11,borderRadius:'50%',
            background:'#2E7D32',border:'2px solid #fff',boxShadow:'0 0 0 1px rgba(0,0,0,.4)'}}></span>
          <span>Receiver — within limit</span>
        </div>
        <div className="recv-row">
          <span style={{display:'inline-block',width:11,height:11,borderRadius:'50%',
            background:'#C0392B',border:'2px solid #fff',boxShadow:'0 0 0 1px rgba(0,0,0,.4)'}}></span>
